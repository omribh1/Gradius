   ...
   // private Button btnGo;
    ...
    private void getDirection() {
        ...
        try{
            ...
            Log.d("Gradius",requestApi);    //Print URL for debug
                    ...
                    .enqueue(new Callback<String>() {
                        ...
                        public void onResponse(Call<String> call, Response<String> response) {
                            ...
                            try {
                                ...
                                //Animation
                                ValueAnimator polyLaineAnimator = ValueAnimator.ofInt(0,100);
                                polyLaineAnimator.setDuration(2000);
                                polyLaineAnimator.setInterpolator(new LinearInterpolator());
                                polyLaineAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                                    @Override
                                    public void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Create Area
        LatLng dan_area = new LatLng(37.422,-122.084);//(mLastLocation.getLatitude(),mLastLocation.getLongitude());
        mMap.addCircle(new CircleOptions()
                .center(dan_area)
                .radius(500)    //500 metters
        ...
        //Add GeoQuery here
        //0.5f = 0.5 km = 500 m
        GeoQuery geoQuery = geoFire.queryAtLocation(new GeoLocation(dan_area.latitude,dan_area.longitude),0.5f);
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            @Override
            public void onKeyEntered(String key, GeoLocation location) {
                sendNotification("Gradius",String.format("%s is near by",key));
            }

            @Override
            public void onKeyExited(String key) {
                sendNotification("Gradius",String.format("%s is out of area",key));
            }
